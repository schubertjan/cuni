...
plot(e_x*e_y, type = "h", main = "(X-E[X])(Y-E[Y])")
...
#zobrazime
hist(r_bootstrap, main = "Bootsrapované rozložení r")

#pokud chceme zjistit 90% interval spolehlivosti
