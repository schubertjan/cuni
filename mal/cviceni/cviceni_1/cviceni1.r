...
# ------------------------------------------------
# INTRODUCTION
# v kratkosti predstavit jednotliva okna v RStudio (zejmena Source a Console; pozdeji ukazat, ze objekty se ukladaji/zobrazuji v Global Environment)
# upozornit, ze R je case-sensitive (a != A), dulezite napriklad i u nazvu funkci (rank != Rank)
# ------------------------------------------------
...
# volání funkce má v R následující obecnou formu: název_funkce(argumenty_funkce)
...
vek_vector %*% delka_studia # výsledkem je matice 1x1
